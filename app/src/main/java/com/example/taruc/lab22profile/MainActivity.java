...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        //requestCode = the nuqiue request code that identify and intent call
    ...
    public void showDial(View v) {
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "0132456789"));
        startActivity(intent);
    }
    ...
    public void showSendTo(View v) {
        ...
        intent.setData(Uri.parse("mailto:" + "melvintan731119@gmail.com"));
